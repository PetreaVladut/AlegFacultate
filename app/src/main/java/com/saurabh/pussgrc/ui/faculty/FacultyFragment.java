...
public class FacultyFragment extends Fragment {
    ...
    private void csDepartment() {
        ...
        csDepartment.setVisibility(View.VISIBLE);
        list1 = new ArrayList<>();
        list1.add(new TeacherData("Informatica Romana","fmi@e-uvt.ro","Facultatea de Matematica Informatica - UVT",null,null));
        list1.add(new TeacherData("Informatica Engleza","fmi@e-uvt.ro","Facultatea de Matematica Informatica - UVT",null,null));
            csDepartment.setHasFixedSize(true);
            csDepartment.setLayoutManager(new LinearLayoutManager(getContext()));
            adapter = new TeacherAdapter(list1,getContext());
            csDepartment.setAdapter(adapter);
    ...
    private void itDepartment() {
        ...
        itDepartment.setVisibility(View.VISIBLE);
        list1 = new ArrayList<>();
        list1.add(new TeacherData("Informatica Aplicata","rector@upt.ro","Universitatea Politehnica din Timisoara - UPT",null,null));
        list1.add(new TeacherData("Sisteme Electrice","rector@upt.ro","Universitatea Politehnica din Timisoara - UPT",null,null));
        itDepartment.setHasFixedSize(true);
        itDepartment.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new TeacherAdapter(list1,getContext());
        itDepartment.setAdapter(adapter);
    ...
    private void eceDepartment() {
        ...
        eceDepartment.setVisibility(View.VISIBLE);
        list1 = new ArrayList<>();
        list1.add(new TeacherData("Electromecanica","rector@upt.ro","Universitatea Politehnica din Timisoara - UPT",null,null));
        list1.add(new TeacherData("Sisteme Electrice","rector@upt.ro","Universitatea Politehnica din Timisoara - UPT",null,null));
        eceDepartment.setHasFixedSize(true);
        eceDepartment.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new TeacherAdapter(list1,getContext());
    ...
    private void mechDepartment() {
        ...
        mechDepartment.setVisibility(View.VISIBLE);
        list1 = new ArrayList<>();
        list1.add(new TeacherData("Calculatoare","rector@upt.ro","Universitatea Politehnica din Timisoara - UPT",null,null));
        list1.add(new TeacherData("Tehnologia informatiei","rector@upt.ro","Universitatea Politehnica din Timisoara - UPT",null,null));
        mechDepartment.setHasFixedSize(true);
        mechDepartment.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new TeacherAdapter(list1,getContext());
        mechDepartment.setAdapter(adapter);
